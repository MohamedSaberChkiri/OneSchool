    ...
    >
      <List className="sidebarmenu-container">
        ...
        >
          <Button
            variant="ghost"
            className="w-11/12 text-white bg-indigo-600 hover:bg-indigo-700  hover:text-white"
          >
            Home
          </Button>
        </Link>
        ...
        >
          <Button
            className={` w-11/12 bg-indigo-700 text-white hover:bg-indigo-900 ${
              scrolled ? "scrolled" : ""
            }`}
          >
            Contact Us
    ...
    <div className={`Header-container ${scrolled ? "scrolled" : ""}`}>
      ...
      <div className="contactus">
        <Link to="contact" smooth={true} duration={500} offset={-70}>
          <Button
            className={`bg-indigo-700 text-white  hidden sm:inline-block hover:bg-indigo-900 ${
              scrolled ? "scrolled" : ""
            }`}
          >
            Contact Us
          ...
          {["right"].map((anchor) => (
            <React.Fragment key={anchor}>
              <RxHamburgerMenu
                ...
                className="inline-block sm:hidden text-3xl text-white cursor-pointer"
              />
